...
if neovim.has("neogen") then
  ...
  maps.n["<Leader>nc"] = {
    function()
      require("neogen").generate({ snippet_engine = "luasnip", type = "class" })
    end,
...
maps.n["<leader>us"] = {
  function()
    neovim.toggle_opt("spell")
  end,
  desc = "Toggle Spelling",
}
maps.n["<leader>uw"] = {
  function()
    neovim.toggle_opt("wrap")
  end,
...
maps.n["<leader>uc"] = {
  function()
    neovim.toggle_opt("conceallevel", false, { 0, conceallevel })
  end,
  desc = "Toggle Conceal",
}
-- }}
...
maps.n["<leader>gg"] = {
  function()
    neovim.float_term({ "lazygit" }, { cwd = neovim.get_root() })
  end,
  desc = "Lazygit (root dir)",
}
maps.n["<leader>gG"] = {
  function()
    neovim.float_term({ "lazygit" })
  end,
  desc = "Lazygit (cwd)",
}
-- floating terminal
maps.n["<leader>ft"] = {
  function()
    neovim.float_term(nil, { cwd = neovim.get_root() })
  end,
